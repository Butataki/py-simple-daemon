...
.. py:module:: __init__.py
    :synopsis: Below is the Daemon class. To use it, simply subclass it and implement the run() method.
...
class Daemon(object):
    ...
    def __init__(self, pid_file, stdin='/dev/null', stdout='/dev/null', stderr='/dev/null', **kwargs):
        self.stdin = stdin
        self.stdout = stdout
        self.stderr = stderr
